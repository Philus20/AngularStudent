...
export class SearchProfileComponent {
  ...
  temp!:Register
         constructor(public sShared:SharedService, public emailS:EmailService, private router:Router){
         
          console.log(this.sShared.profileSearch)
         ...
         this.gettingPosts()
         // this.getPostProfileData() 
        
      }
      
      
gettingPosts(){
  this.sShared.shareId$.subscribe({
    next:(x)=>{
      this.shareId=x
      this.getPostProfileData()
      ...
      if(this.shareId)
        this.emailS.getPosts(this.shareId).subscribe({
          next: (posts: any) => {
...
getPostProfileData(){
  this.emailS.getStudentId(this.shareId).subscribe({
    next: (x:any)=>{
      this.student = x;
