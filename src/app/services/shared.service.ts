...
emitSearchItem =  new Subject<string>();
emitSearchItem$ = this.emitSearchItem.asObservable();

shareSearchItem(m:string){
  this.emitSearchItem.next(m)
}

shareId = new Subject<number>();
shareId$ = this.shareId.asObservable();
}
